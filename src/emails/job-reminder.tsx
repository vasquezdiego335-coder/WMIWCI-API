...
interface Props { customerName: string; scheduledStart?: string; originAddress: string; portalUrl: string }
export default function JobReminderEmail({ customerName = 'Friend', scheduledStart, originAddress = 'Origin', portalUrl = '#' }: Props) {
      ...
      <Body style={{ backgroundColor: '#F5F1EA', fontFamily: 'Inter, sans-serif' }}>
        <Container style={{ maxWidth: '560px', margin: '0 auto', padding: '24px 16px' }}>
          ...
          <Section style={{ backgroundColor: '#FFFFFF', padding: '32px 28px', borderRadius: '0 0 12px 12px' }}>
            <Heading style={{ fontSize: '20px', fontWeight: '700', color: '#0A1628', margin: '0 0 16px' }}>⏰ Your move is tomorrow!</Heading>
