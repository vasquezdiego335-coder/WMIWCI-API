...
interface Props { customerName: string; completedAt?: string; portalUrl: string }
export default function JobCompletionEmail({ customerName = 'Friend', completedAt, portalUrl = '#' }: Props) {
  return (
    <Html lang="en"><Head />
