...
interface Props { customerName: string; checkoutUrl: string }
export default function AbandonedCheckoutEmail({ customerName = 'Friend', checkoutUrl = '#' }: Props) {
  return (
    <Html lang="en"><Head />
      <Body style={{ backgroundColor: '#F5F1EA', fontFamily: 'Inter, sans-serif' }}>
        <Container style={{ maxWidth: '560px', margin: '0 auto', padding: '24px 16px' }}>
          ...
          <Section style={{ backgroundColor: '#FFFFFF', padding: '32px 28px', borderRadius: '0 0 12px 12px' }}>
            <Heading style={{ fontSize: '20px', fontWeight: '700', color: '#0A1628', margin: '0 0 16px' }}>Your date is still available 📅</Heading>
