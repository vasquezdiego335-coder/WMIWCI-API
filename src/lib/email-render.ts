...
export const RENDERERS: Record<string, Renderer> = {
  ...
  'lead-nurture-1': (p) => LeadNurtureEmail({ ...p, stage: 1 } as never),
  'lead-nurture-2': (p) => LeadNurtureEmail({ ...p, stage: 2 } as never),
  'lead-nurture-final': (p) => LeadNurtureEmail({ ...p, stage: 3 } as never),
