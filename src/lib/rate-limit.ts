...
export const LIMITS = {
  ...
  // Quick-quote submissions. Far tighter than partialLead: that one fires on
  // every keystroke-debounce, this one on a deliberate submit. failMode 'open'
  // because a limiter outage must never stop a customer seeing their estimate.
